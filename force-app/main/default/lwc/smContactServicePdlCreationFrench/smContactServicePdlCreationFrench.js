...
import { OMNIDEF } from './smContactServicePdlCreationFrench_def.js';
import tmpl from './smContactServicePdlCreationFrench.html';
import tmpl_nds from './smContactServicePdlCreationFrench_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class smContactServicePdlCreationFrench extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

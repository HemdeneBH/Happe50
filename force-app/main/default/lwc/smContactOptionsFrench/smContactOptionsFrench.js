...
import { OMNIDEF } from './smContactOptionsFrench_def.js';
import tmpl from './smContactOptionsFrench.html';
import tmpl_nds from './smContactOptionsFrench_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class smContactOptionsFrench extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

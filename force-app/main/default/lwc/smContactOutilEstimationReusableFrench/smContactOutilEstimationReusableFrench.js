...
import { OMNIDEF } from './smContactOutilEstimationReusableFrench_def.js';
import tmpl from './smContactOutilEstimationReusableFrench.html';
import tmpl_nds from './smContactOutilEstimationReusableFrench_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class smContactOutilEstimationReusableFrench extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

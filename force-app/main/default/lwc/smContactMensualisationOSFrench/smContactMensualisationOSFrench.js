...
import { OMNIDEF } from './smContactMensualisationOSFrench_def.js';
import tmpl from './smContactMensualisationOSFrench.html';
import tmpl_nds from './smContactMensualisationOSFrench_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class smContactMensualisationOSFrench extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

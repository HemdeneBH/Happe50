...
import { OMNIDEF } from './smContactModificationCOOBFrench_def.js';
import tmpl from './smContactModificationCOOBFrench.html';
import tmpl_nds from './smContactModificationCOOBFrench_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class smContactModificationCOOBFrench extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

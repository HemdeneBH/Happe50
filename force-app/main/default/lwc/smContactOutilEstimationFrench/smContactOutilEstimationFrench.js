...
import { OMNIDEF } from './smContactOutilEstimationFrench_def.js';
import tmpl from './smContactOutilEstimationFrench.html';
import tmpl_nds from './smContactOutilEstimationFrench_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class smContactOutilEstimationFrench extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

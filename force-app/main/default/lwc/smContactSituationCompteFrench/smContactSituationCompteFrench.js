...
import { OMNIDEF } from './smContactSituationCompteFrench_def.js';
import tmpl from './smContactSituationCompteFrench.html';
import tmpl_nds from './smContactSituationCompteFrench_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class smContactSituationCompteFrench extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

...
import { OMNIDEF } from './smContactPayeurDivergentFrench_def.js';
import tmpl from './smContactPayeurDivergentFrench.html';
import tmpl_nds from './smContactPayeurDivergentFrench_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class smContactPayeurDivergentFrench extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

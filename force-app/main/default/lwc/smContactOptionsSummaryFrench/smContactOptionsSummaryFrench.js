...
import { OMNIDEF } from './smContactOptionsSummaryFrench_def.js';
import tmpl from './smContactOptionsSummaryFrench.html';
import tmpl_nds from './smContactOptionsSummaryFrench_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class smContactOptionsSummaryFrench extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

...
import { OMNIDEF } from './smContactSyntheseBlocageFrench_def.js';
import tmpl from './smContactSyntheseBlocageFrench.html';
import tmpl_nds from './smContactSyntheseBlocageFrench_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class smContactSyntheseBlocageFrench extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

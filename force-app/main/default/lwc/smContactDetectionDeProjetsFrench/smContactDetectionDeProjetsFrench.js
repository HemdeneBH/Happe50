...
import { OMNIDEF } from './smContactDetectionDeProjetsFrench_def.js';
import tmpl from './smContactDetectionDeProjetsFrench.html';
import tmpl_nds from './smContactDetectionDeProjetsFrench_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class smContactDetectionDeProjetsFrench extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

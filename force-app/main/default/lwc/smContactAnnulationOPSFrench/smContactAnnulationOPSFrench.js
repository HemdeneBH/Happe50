...
import { OMNIDEF } from './smContactAnnulationOPSFrench_def.js';
import tmpl from './smContactAnnulationOPSFrench.html';
import tmpl_nds from './smContactAnnulationOPSFrench_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class smContactAnnulationOPSFrench extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

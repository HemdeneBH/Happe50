...
import { OMNIDEF } from './smContactAjustementMensFrench_def.js';
import tmpl from './smContactAjustementMensFrench.html';
import tmpl_nds from './smContactAjustementMensFrench_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class smContactAjustementMensFrench extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

...
import { OMNIDEF } from './coeTestDeploymentEnglish_def.js';
import tmpl from './coeTestDeploymentEnglish.html';
import tmpl_nds from './coeTestDeploymentEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class coeTestDeploymentEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

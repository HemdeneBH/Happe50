...
import { OMNIDEF } from './smContactCreerContactFrench_def.js';
import tmpl from './smContactCreerContactFrench.html';
import tmpl_nds from './smContactCreerContactFrench_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class smContactCreerContactFrench extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

...
import { OMNIDEF } from './smContactMensualisationFrench_def.js';
import tmpl from './smContactMensualisationFrench.html';
import tmpl_nds from './smContactMensualisationFrench_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class smContactMensualisationFrench extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

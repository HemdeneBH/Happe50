import { FlexCardMixin } from "vlocity_cmt/flexCardMixin";
    import {interpolateWithRegex, interpolateKeyValue, fetchCustomLabels } from "vlocity_cmt/flexCardUtility";
          ...
          export default class cfSmOffresSelectionDetailsOutilEstimation extends FlexCardMixin(LightningElement){
              @api debug;
              @api recordId;
              ...
              connectedCallback() {
                ...
                this.setAttribute(
                  "class",
                  "card-a3t1v000001uYCsAAM"
                );
                this.getCommunityPrefix().then((result) => {
                  loadStyle(this, result +"/servlet/servlet.FileDownload?file=00P1v00001OsHGSEA3").then(() =>{
                    //Loading Custom CSS.
                  })
                });

...
import { OMNIDEF } from './smContactStandaloneOptionsFrench_def.js';
import tmpl from './smContactStandaloneOptionsFrench.html';
import tmpl_nds from './smContactStandaloneOptionsFrench_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class smContactStandaloneOptionsFrench extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

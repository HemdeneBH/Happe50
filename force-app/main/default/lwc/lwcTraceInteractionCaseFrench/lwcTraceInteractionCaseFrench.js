...
import { OMNIDEF } from './lwcTraceInteractionCaseFrench_def.js';
import tmpl from './lwcTraceInteractionCaseFrench.html';
import tmpl_nds from './lwcTraceInteractionCaseFrench_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class lwcTraceInteractionCaseFrench extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

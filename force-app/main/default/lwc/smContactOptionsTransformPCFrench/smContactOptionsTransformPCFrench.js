...
import { OMNIDEF } from './smContactOptionsTransformPCFrench_def.js';
import tmpl from './smContactOptionsTransformPCFrench.html';
import tmpl_nds from './smContactOptionsTransformPCFrench_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class smContactOptionsTransformPCFrench extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

...
import { OMNIDEF } from './smContactContestationIndexFrench_def.js';
import tmpl from './smContactContestationIndexFrench.html';
import tmpl_nds from './smContactContestationIndexFrench_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class smContactContestationIndexFrench extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

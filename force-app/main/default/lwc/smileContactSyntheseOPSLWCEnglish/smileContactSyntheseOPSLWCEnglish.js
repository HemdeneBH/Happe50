...
import { OMNIDEF } from './smileContactSyntheseOPSLWCEnglish_def.js';
import tmpl from './smileContactSyntheseOPSLWCEnglish.html';
import tmpl_nds from './smileContactSyntheseOPSLWCEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class smileContactSyntheseOPSLWCEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

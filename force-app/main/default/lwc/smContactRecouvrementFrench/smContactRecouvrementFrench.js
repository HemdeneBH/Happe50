...
import { OMNIDEF } from './smContactRecouvrementFrench_def.js';
import tmpl from './smContactRecouvrementFrench.html';
import tmpl_nds from './smContactRecouvrementFrench_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class smContactRecouvrementFrench extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

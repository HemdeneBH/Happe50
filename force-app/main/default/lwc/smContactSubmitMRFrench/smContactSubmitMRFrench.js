...
import { OMNIDEF } from './smContactSubmitMRFrench_def.js';
import tmpl from './smContactSubmitMRFrench.html';
import tmpl_nds from './smContactSubmitMRFrench_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class smContactSubmitMRFrench extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

...
import { OMNIDEF } from './smContactRequestForDuplicateEnglish_def.js';
import tmpl from './smContactRequestForDuplicateEnglish.html';
import tmpl_nds from './smContactRequestForDuplicateEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class smContactRequestForDuplicateEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

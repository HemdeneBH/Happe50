...
import { OMNIDEF } from './smContactOptionsOrderValidationFrench_def.js';
import tmpl from './smContactOptionsOrderValidationFrench.html';
import tmpl_nds from './smContactOptionsOrderValidationFrench_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class smContactOptionsOrderValidationFrench extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

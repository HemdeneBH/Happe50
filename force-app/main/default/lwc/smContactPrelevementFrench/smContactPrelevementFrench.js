...
import { OMNIDEF } from './smContactPrelevementFrench_def.js';
import tmpl from './smContactPrelevementFrench.html';
import tmpl_nds from './smContactPrelevementFrench_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class smContactPrelevementFrench extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
